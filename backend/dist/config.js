...
const rawFrontendBaseUrl = process.env.FRONTEND_BASE_URL || process.env.FRONTEND_URL || process.env.NEXT_PUBLIC_API_BASE_URL;
export const FRONTEND_BASE_URL = (rawFrontendBaseUrl || 'https://gohan-expo.vercel.app').replace(/\/$/, '');
...
export const ENABLE_LINE_GROUPMEAL_REMINDER = process.env.ENABLE_LINE_GROUPMEAL_REMINDER !== "false";
...
const parsedInviteTokenTtlHours = Number(process.env.INVITE_TOKEN_TTL_HOURS ?? "168");
export const INVITE_TOKEN_TTL_HOURS = Number.isFinite(parsedInviteTokenTtlHours) && parsedInviteTokenTtlHours > 0
