...
import { DEFAULT_COMMUNITY_NAME, DEFAULT_COMMUNITY_CODE, } from '../config.js';
async function main() {
    if (!DEFAULT_COMMUNITY_NAME || !DEFAULT_COMMUNITY_CODE) {
        throw new Error('DEFAULT_COMMUNITY_NAME / DEFAULT_COMMUNITY_CODE が設定されていません。.env を確認してください。');
    }
